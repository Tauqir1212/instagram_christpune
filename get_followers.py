...
options.add_extension("/Users/nilaymishra/Downloads/Archive_3/instagram_wendy/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/nilaymishra/Downloads/{}_followers.csv /Users/nilaymishra/Downloads/Archive_3/instagram_wendy/accounts'.format(account))
        except:
